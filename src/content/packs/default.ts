...
export const DEFAULT_CONTENT_PACK = defineContentPack({
  ...
  items: {
    ...
    charcoal: {
      ...
      sources: ["craft"],
      description:
        "Slow-burned wood. Hotter and cleaner than coal. Every alchemist keeps a supply.",
    },
    resin: {
      id: "resin",
      name: "Tree Resin",
    ...
    red_herb: {
      ...
      sources: ["gather", "expedition"],
      description:
        "Grows in essence-rich clearings. The base ingredient for most healing compounds.",
    },
    blue_moss: {
      id: "blue_moss",
      name: "Blue Moss",
    ...
    ghost_lily: {
      ...
      sources: ["expedition"],
      description:
        "Translucent white flower found near Blight zones. Wilts within hours of picking.",
    },
    swamp_root: {
      id: "swamp_root",
      name: "Swamp Root",
    ...
    witchgrass: {
      ...
      sources: ["expedition"],
      description:
        "Thin black grass that grows in perfect circles. Essence radiates from the roots.",
    },
    corpse_flower: {
      id: "corpse_flower",
      name: "Corpse Flower",
    ...
    volatile_ash: {
      ...
      sources: ["craft"],
      description:
        "The residue of a failed Crucible synthesis. Grey, inert, worthless. A reminder.",
    },
    essence_dust: {
      id: "essence_dust",
      name: "Essence Dust",
    ...
    binding_agent: {
      ...
      sources: ["craft"],
      description:
        "Thick paste made from resin and mineral powder. Holds anything to anything else.",
    },
    bandage: {
      id: "bandage",
      name: "Linen Bandage",
    ...
    stimulant_tonic: {
      ...
      sources: ["craft"],
      description:
        "Bitter green liquid. Temporarily sharpens reflexes. Withdrawal hits like a cart.",
    },
    blood_vial: {
      id: "blood_vial",
      name: "Blood Vial",
      ...
      sources: ["craft", "expedition"],
      description:
        "Preserved blood treated with essence stabilizer. Emergency transfusion material.",
    },
    anti_grey_serum: {
      id: "anti_grey_serum",
    ...
    chainmail: {
      ...
      sources: ["craft"],
      description:
        "Interlocking iron rings sewn onto leather backing. Heavy. Effective. Expensive.",
    },
    wooden_shield: {
      id: "wooden_shield",
      name: "Wooden Shield",
    ...
    crushed_copper: {
      ...
      sources: ["craft"],
      description:
        "Copper ore reduced to fine granules. Ready for smelting or alchemical solution.",
    },
    iron_shards: {
      id: "iron_shards",
      name: "Iron Shards",
    ...
    glass_shards: {
      ...
      sources: ["craft"],
      description:
        "Broken glass. Dangerous to handle, but useful for optics or as a cheap abrasive.",
    },
    processed_wax: {
      id: "processed_wax",
      name: "Processed Wax",
