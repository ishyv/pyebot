/**
 * Legacy source-pack reader/writer for the typed RPG content pack at
 * `src/content/packs/default.ts` in the parent bot project.
 *
 * Runtime dashboard edits now go through the bot bridge and persist to Mongo
 * `rpg_content.active`; this module remains for item-manager style source-pack
 * tooling and shared item validation.
 *
 * Absorbed from the standalone `item-manager` subproject in 2026-05.
 */
...
/** Runtime boundary for dashboard JSON before it enters the RPG content snapshot. */
